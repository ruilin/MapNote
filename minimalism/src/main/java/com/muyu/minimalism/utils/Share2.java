...
public class Share2 {
    ...
    private Share2(@NonNull Share2.Builder builder) {
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Share2.Builder setContentType(@ShareContentType String contentType) {
         ...
         * @return Builder
         */
        public Share2.Builder setTitle(@NonNull String title) {
            this.title = title;
            return this;
        }
         ...
         * @return Builder
         */
        public Share2.Builder setShareFileUri(Uri shareFileUri) {
         ...
         * @return Builder
         */
        public Share2.Builder setTextContent(String textContent) {
         ...
         * @return Builder
         */
        public Share2.Builder setShareToComponent(String componentPackageName, String componentClassName) {
         ...
         * @return Builder
         */
        public Share2.Builder setOnActivityResult (int requestCode) {
         ...
         * @return Builder
         */
        public Share2.Builder forcedUseSystemChooser (boolean enable) {
